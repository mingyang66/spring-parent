...
- [apidoc文档生成操作手册](https://github.com/mingyang66/spring-parent/tree/master/emily-spring-boot-project/web-spring-boot-starter/apidoc.md)
...
- [datasource-spring-boot-starter数据库多数据源SDK使用手册](https://github.com/mingyang66/spring-parent/tree/master/emily-spring-boot-project/datasource-spring-boot-starter/README.md)
...
- [redis-spring-boot-starter组件SDK使用手册](https://github.com/mingyang66/spring-parent/blob/master/emily-spring-boot-project/redis-spring-boot-starter/README.md)
- [amqp-spring-boot-starter组件SDK使用手册](https://github.com/mingyang66/spring-parent/blob/master/emily-spring-boot-project/amqp-spring-boot-starter/README.md)
