package com.emily.boot.autoconfigure.idempotent;

import com.emily.boot.autoconfigure.idempotent.interceptor.IdempotentMethodBeforeAdvice;
...
public class IdempotentAutoConfiguration implements InitializingBean, DisposableBean {
     ...
     */
    private static final String REPEAT_SUBMIT_POINT_CUT = StringUtils.join("@annotation(com.emily.boot.autoconfigure.idempotent.annotation.ApiIdempotent)");
