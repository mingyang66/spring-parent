package com.emily.boot.autoconfigure.ratelimit;

import com.emily.boot.autoconfigure.ratelimit.interceptor.RateLimitMethodBeforeAdvice;
...
public class RateLimitAutoConfiguration implements InitializingBean, DisposableBean {
     ...
     */
    private static final String RATE_LIMIT_POINT_CUT = StringUtils.join("@annotation(com.emily.boot.autoconfigure.ratelimit.annotation.ApiRateLimit)");
