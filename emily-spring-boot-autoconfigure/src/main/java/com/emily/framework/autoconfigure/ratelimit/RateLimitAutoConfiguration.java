package com.emily.framework.autoconfigure.ratelimit;
...
public class RateLimitAutoConfiguration implements InitializingBean, DisposableBean {
     ...
     */
    private static final String RATE_LIMIT_POINT_CUT = StringUtils.join("@annotation(com.emily.framework.autoconfigure.ratelimit.annotation.ApiRateLimit)");
