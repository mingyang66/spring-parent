...
public class IdempotentAutoConfiguration implements InitializingBean, DisposableBean {
     ...
     */
    private static final String REPEAT_SUBMIT_POINT_CUT = StringUtils.join("@annotation(com.emily.infrastructure.autoconfigure.idempotent.annotation.ApiIdempotent)");
