...
@ConditionalOnProperty(prefix = RequestLoggerProperties.PREFIX, name = "enabled", havingValue = "true", matchIfMissing = true)
public class RequestLoggerAutoConfiguration implements InitializingBean, DisposableBean {
    ...
    public DefaultPointcutAdvisor apiLogNormalPointCutAdvice() {
        ...
        //设置增强（Advice）
        advisor.setAdvice(new RequestLoggerMethodInterceptor());
        //设置增强拦截器执行顺序
