package com.emily.boot.common.mail;

import com.emily.boot.common.exception.BusinessException;
import com.emily.boot.common.mail.model.MailMessage;
...
public class MailFactoryBean {
     ...
     * @return
     */
    public static boolean sendMimeMail(JavaMailSender javaMailSender, com.emily.boot.common.mail.model.MimeMailMessage message) {
        try {
