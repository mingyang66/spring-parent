package com.emily.boot.common.utils.io;
...
public class FileUtils {
    ...
    public static String readRemoteFile(String url, String encoding) {
        try {
            ...
            throw new BusinessException(AppHttpStatus.READ_RESOURSE_NOT_FOUND_EXCEPTION.getStatus(), StringUtils.join("读取文件：", url, "发生异常", e));
        }
    }
