...
public class JavaBeanUtils {
    ...
    public static <T> Map<String, Object> copyToMap(T bean) {
        ...
        try {
            ...
            throw new BaseException(AppHttpStatus.CLASS_CAST_EXCEPTION.getStatus(), PrintExceptionInfo.printErrorInfo(e));
        }
    }
    ...
    public static <T> T deepCopy(T obj) {
        try {
            ...
            throw new BaseException(AppHttpStatus.EXCEPTION.getStatus(), "未实现序列化接口");
        } catch (Exception exception) {
            throw new BaseException(AppHttpStatus.EXCEPTION.getStatus(), "深度拷贝数据异常");
        }
    }
}
