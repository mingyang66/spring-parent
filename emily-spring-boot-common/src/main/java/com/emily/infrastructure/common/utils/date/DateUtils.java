...
public class DateUtils {
    ...
    public static Long dateToNum(Date date, String format) {
        if (Objects.isNull(date)) {
            throw new BasicException(AppHttpStatus.ILLEGAL_PARAMETER.getStatus(), "日期参数不可以为空");
        }
    ...
    public static LocalDate numToLocalDate(Long date, String format) {
        ...
        if (String.valueOf(date).length() > 8) {
            throw new BasicException(AppHttpStatus.ILLEGAL_PARAMETER.getStatus(), "数字类型日期不可以包含时间");
        }
    ...
    public static LocalDateTime numToLocalDateTime(Long date, String format) {
        ...
        if (String.valueOf(date).length() < 10) {
            throw new BasicException(AppHttpStatus.ILLEGAL_PARAMETER.getStatus(), "数字类型日期必须包含时间");
        }
    ...
    public static Long strToNum(String dateStr, String originFormat, String format) {
        ...
        if (Objects.isNull(originFormat)) {
            throw new BasicException(AppHttpStatus.ILLEGAL_PARAMETER.getStatus(), "原日期格式参数不可以为空");
        }
        if (Objects.isNull(format)) {
            throw new BasicException(AppHttpStatus.ILLEGAL_PARAMETER.getStatus(), "目标日期格式参数不可以为空");
        }
    ...
    public static Duration between(LocalDateTime startDate, LocalDateTime endDate) {
        if (Objects.isNull(startDate)) {
            throw new BasicException(AppHttpStatus.ILLEGAL_PARAMETER.getStatus(), "参数不可以为空");
        }
        if (Objects.isNull(startDate)) {
            throw new BasicException(AppHttpStatus.ILLEGAL_PARAMETER.getStatus(), "参数不可以为空");
        }
