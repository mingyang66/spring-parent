...
public class FileUtils {
    ...
    public static String readRemoteFile(String url, String encoding) {
        try {
            ...
            throw new BaseException(AppHttpStatus.ILLEGAL_ARGUMENT_EXCEPTION.getStatus(), StringUtils.join("读取文件：", url, "发生异常", e));
        }
    }
    ...
    public static void write(final File file, final CharSequence data, final boolean append, final String encoding) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "写入数据异常，" + e);
        }
    }
    ...
    public static String readFileToString(final File file, final String encoding) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "读取资源异常，" + e);
        }
    }
    ...
    public static URL[] toUrls(final File[] files) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "资源转换异常, " + e);
        }
    }
    ...
    public static void deleteDirectory(final File directory) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "删除资源异常, " + e);
        }
    }
    ...
    public static void forceMkdir(final File directory) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "创建目录异常, " + e);
        }
    }
    ...
    public static FileInputStream openInputStream(final File file) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "打开指定文件的输入流异常, " + e);
        }
    }
    ...
    public static FileOutputStream openOutputStream(final File file) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "打开指定文件的输出流异常, " + e);
        }
    }
    ...
    public static boolean directoryContains(final File directory, final File child) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "判定父file对象是否包含子file对象异常, " + e);
        }
    }
    ...
    public static boolean contentEquals(final File file1, final File file2) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "比较两个文件内容是否相等异常, " + e);
        }
    }
    ...
    public static Checksum checksum(final File file, final Checksum checksum) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "校验文件数据异常, " + e);
        }
    }
    ...
    public static void cleanDirectory(final File directory) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "清空目录异常, " + e);
        }
    }
    ...
    public static void copyDirectory(final File srcDir, final File destDir, final FileFilter filter, final boolean preserveFileDate) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "复制资源异常, " + e);
        }
    }
    ...
    public static boolean isSymlink(final File file) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "确定指定的文件是符号链接而不是实际文件异常, " + e);
        }
    }
    ...
    public static LineIterator lineIterator(final File file, final String encoding) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "获取指定文件行的Iterator迭代器异常, " + e);
        }
    }
    ...
    public static void moveDirectory(final File srcDir, final File destDir) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "移动目录异常, " + e);
        }
    }
    ...
    public static void moveFile(final File srcFile, final File destFile) {
        try {
            ...
            throw new BaseException(AppHttpStatus.IO_EXCEPTION.getStatus(), "移动文件异常, " + e);
        }
    }
