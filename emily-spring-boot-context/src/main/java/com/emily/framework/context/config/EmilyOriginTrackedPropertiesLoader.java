...
package com.emily.framework.context.config;
 ...
 */
class EmilyOriginTrackedPropertiesLoader {
    ...
    Map<String, OriginTrackedValue> load(boolean expandLists) throws IOException {
        try (EmilyOriginTrackedPropertiesLoader.CharacterReader reader = new EmilyOriginTrackedPropertiesLoader.CharacterReader(this.resource)) {
    ...
    private String loadKey(StringBuilder buffer, EmilyOriginTrackedPropertiesLoader.CharacterReader reader) throws IOException {
        buffer.setLength(0);
    ...
    private OriginTrackedValue loadValue(StringBuilder buffer, EmilyOriginTrackedPropertiesLoader.CharacterReader reader, boolean splitLists)
            throws IOException {
        buffer.setLength(0);
