...
public class DataSourceAutoConfiguration implements BeanFactoryPostProcessor, InitializingBean, DisposableBean {
    ...
    public DataSource dynamicMultiRoutingDataSource(final DataSourceProperties properties) {
        //获取默认数据库配置
        Object defaultTargetDataSource = Objects.requireNonNull(properties.getDefaultDataSource(), "默认数据库必须配置");
        //动态切换多数据源对象
        ...
        dynamicMultiRoutingDataSource.setTargetDataSources(properties.getTargetDataSources());
