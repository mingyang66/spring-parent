...
import com.emily.infrastructure.amqp.DataRabbitProperties;
import com.emily.infrastructure.amqp.common.DataRabbitInfo;
import com.emily.infrastructure.amqp.listener.DataRabbitConnectionListener;
import com.emily.infrastructure.amqp.listener.DataRabbitExceptionHandler;
 ...
 * org.springframework.boot.amqp.autoconfigure.RabbitAutoConfiguration.RabbitConnectionFactoryCreator
 *
 * @author Emily
