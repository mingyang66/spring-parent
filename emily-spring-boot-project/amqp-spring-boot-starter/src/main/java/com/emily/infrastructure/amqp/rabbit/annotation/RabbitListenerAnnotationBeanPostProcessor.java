...
/**
 * 源码：{@link org.springframework.amqp.rabbit.annotation.RabbitListenerAnnotationBeanPostProcessor}
...
public class RabbitListenerAnnotationBeanPostProcessor extends AbstractListenerAnnotationBeanPostProcessor<RabbitListener> {
    ...
    public void setEnvironment(Environment environment) {
        ...
        String property = environment.getProperty(RabbitListenerAnnotationBeanPostProcessor.RABBIT_EMPTY_STRING_ARGUMENTS_PROPERTY, String.class);
        if (property != null) {
