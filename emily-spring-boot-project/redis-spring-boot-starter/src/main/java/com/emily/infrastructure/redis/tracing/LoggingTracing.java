...
public class LoggingTracing implements Tracing {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(LoggingTracing.class);
    ...
    public Endpoint createEndpoint(SocketAddress socketAddress) {
        ...
        LOG.info("Cannot create endpoint for unsupported SocketAddress type: {}", socketAddress.getClass().getName());
     ...
     * @param port
     */
    record LoggingEndpoint(String host, int port) implements Endpoint {
    }
