package com.emily.infrastructure.test.config.plugin.controller;

import com.emily.infrastructure.test.config.plugin.PeoplePlugin;
import com.emily.infrastructure.test.config.plugin.PeoplePluginType;
