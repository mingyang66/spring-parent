package com.emily.infrastructure.sample.web.config.plugin.controller;

import com.emily.infrastructure.sample.web.config.plugin.PeoplePlugin;
import com.emily.infrastructure.sample.web.config.plugin.PeoplePluginType;
