...
import com.emily.infrastructure.autoconfigure.valid.IsIncludeDoubleValidator;
...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = {IsIncludeDoubleValidator.class})
public @interface IsIncludeDouble {
    /**
     * 提示信息
     */
