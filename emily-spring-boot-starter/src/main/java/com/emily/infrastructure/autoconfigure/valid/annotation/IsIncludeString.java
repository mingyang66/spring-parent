...
import com.emily.infrastructure.autoconfigure.valid.IsIncludeStringValidator;
...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = {IsIncludeStringValidator.class})
public @interface IsIncludeString {
    /**
     * 提示信息
     */
