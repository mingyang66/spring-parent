package com.emily.framework.swagger.config;
...
@ConditionalOnProperty(prefix = "spring.emily.swagger", name = "enable", havingValue = "true", matchIfMissing = true)
public class SwaggerAutoConfiguration implements CommandLineRunner {
    ...
    public void register() {
        ...
        if (ArrayUtils.isEmpty(basePackages)) {
            basePackages = new String[]{"com.emily.framework"};
        }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                //.contact(new Contact("小米粒（emily）", "http://www.emily.com", "emily@qq.com"))
                //.license("Apache2.0")
