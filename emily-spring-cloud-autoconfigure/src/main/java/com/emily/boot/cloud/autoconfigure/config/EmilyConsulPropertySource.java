 ...
 * @author Spencer Gibb
 */
public class EmilyConsulPropertySource extends EnumerablePropertySource<ConsulClient> {
    ...
    public EmilyConsulPropertySource(String context, ConsulClient source,
