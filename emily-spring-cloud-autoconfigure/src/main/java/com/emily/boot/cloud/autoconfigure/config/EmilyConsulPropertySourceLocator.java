package com.emily.boot.cloud.autoconfigure.config;
 ...
 */
@Order(-1)
public class EmilyConsulPropertySourceLocator implements PropertySourceLocator {
    ...
    public EmilyConsulPropertySourceLocator(ConsulClient consul,
    ...
    public PropertySource<?> locate(Environment environment) {
        if (environment instanceof ConfigurableEnvironment) {
            ...
            for (String propertySourceContext : this.contexts) {
                try {
                    EmilyConsulPropertySource propertySource = null;
                    if (this.properties.getFormat() == FILES) {
                        ...
                        if (response.getValue() != null) {
                            EmilyConsulFilesPropertySource filesPropertySource = new EmilyConsulFilesPropertySource(
    ...
    private EmilyConsulPropertySource create(String context, Map<String, Long> contextIndex) {
        EmilyConsulPropertySource propertySource = new EmilyConsulPropertySource(context,
