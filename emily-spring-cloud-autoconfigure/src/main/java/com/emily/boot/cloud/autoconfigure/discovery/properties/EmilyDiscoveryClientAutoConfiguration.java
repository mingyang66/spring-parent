package com.emily.boot.cloud.autoconfigure.discovery.properties;

import com.emily.boot.common.utils.UUIDUtils;
...
public class EmilyDiscoveryClientAutoConfiguration {

    private Environment environment;

    public EmilyDiscoveryClientAutoConfiguration(Environment environment){
    ...
    public ConsulDiscoveryProperties consulDiscoveryProperties(InetUtils inetUtils) {
        ...
        properties.setInstanceId(StringUtils.join("emily", CharacterUtils.LINE_THROUGH_CENTER, UUIDUtils.randomUUID()));
        return properties;
    }
}
