...
import com.emily.infrastructure.rpc.common.NettyConstant;
import com.emily.infrastructure.rpc.entity.ClassInfo;
...
public class NettyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        //确认是rpc调用才往下执行
        if (!StringUtils.equals(NettyConstant.PROTOCOL, classInfo.getProtocol())) {
            return;
        }
        //反射调用实现类的方法
