 ...
 * @since : 2021/12/12
 */
public class LogbackGroupBuilder extends AbstractLogback {
    private final LoggerProperties properties;
    private final LoggerContext loggerContext;

    private LogbackGroupBuilder(LoggerProperties properties, LoggerContext loggerContext) {
    ...
    public static AbstractLogback create(LoggerProperties properties, LoggerContext loggerContext) {
        return new LogbackGroupBuilder(properties, loggerContext);
    }
}
