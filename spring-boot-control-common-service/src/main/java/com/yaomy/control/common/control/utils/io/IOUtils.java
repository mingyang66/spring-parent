...
public class IOUtils {
    ...
    public static boolean contentEquals(InputStream input1, InputStream input2){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "比较两个输入流是否相等异常："+e.toString());
            return false;
        }
    }
    ...
    public static boolean contentEquals(Reader input1, Reader input2){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "比较两个输入字符流是否相等异常："+e.toString());
            return false;
        }
    }
    ...
    public static int copy(final Reader input, final Writer output){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "复制数据流发生异常："+e.toString());
            return 0;
        }
    }
    /**
    ...
    public static long copyLarge(final InputStream input, final OutputStream output){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "复制大数据流异常："+e.toString());
            return 0L;
        }
    }
    /**
    ...
    public static LineIterator lineIterator(final InputStream input, final String encoding){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "读取输入流异常："+e.toString());
            return null;
        }
    }
    ...
    public static int read(final Reader input, final char[] buffer){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "读取字符流异常："+e.toString());
            return 0;
        }
    }
    ...
    public static boolean readFully(final InputStream input, final byte[] buffer, final int offset, final int length){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "读取字节流异常："+e.toString());
            return false;
        }
        return true;
    }
    ...
    public static byte[] resourceToByteArray(final String name){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "资源转为字节数组异常："+e.toString());
            return ArrayUtils.EMPTY_BYTE_ARRAY;
        }
    }
    ...
    public static URL resourceToURL(final String name){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "资源转为URL异常："+e.toString());
            return null;
        }
    }
    ...
    public static String resourceToString(final String name, final Charset encoding){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "资源转为字符串异常："+e.toString());
    ...
    public static boolean write(final byte[] data, final OutputStream output){
        try {
            ...
            e.printStackTrace();
            LoggerUtil.error(IOUtils.class, "写入字节流异常："+e.toString());
            return false;
        }
        return true;
    }
